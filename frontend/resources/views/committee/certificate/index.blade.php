...
@section('content')
    <section class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url('../memberast/images/committee_upload_certificate.png');"
        ...
        <div class="container">
            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    @if (!$hasHistory)
                        <tr>
                            <td colspan="6" class="text-center py-4 text-muted">Belum ada history upload sertifikat</td>
                        </tr>
                    @endif
                </tbody>
            </table>
